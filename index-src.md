...
- 「自分の世界」を創造できる
- その世界がどのような部品や構造で成り立っているのかを掌握できる  
（「作り方」を知ってるぜ、と言える）
- 他にも色々
...
- プログラムの「部品」や「構造」を意識することの重要性が比較的高い
- ゲームに限らず、動きのある作品やインタラクティブな作品に、作り方を応用できる
...
<details>
<summary>補足（上級）： この命名で良いのか</summary>
...
<details>
<summary>補足（上級）： 「エンティティ」という用語について</summary>
